...
static const u8* beforefun[] = {
//"\tcall\tpthread_create\n",
NULL
};

static const u8* afterfun[] = {
//"\tcall\tfree\n",
//"\tcall\t_Znwm\n",
//"\tcall\t_ZdlPv\n",
//"\tcall\tmalloc\n",
...
static const u8* trampoline_random_lock_con =
...
static const u8* trampoline_con =
...
static const u8* trampoline_priority_con =
...
static const u8* main_priority_64 =
...
/*random lock*/
  ...
  "  movl 32(%rdx), %ebx\n"
  "  cmpl %eax, %ebx\n"
  "  jbe __afl_check_another\n"
  "  incl (%rdx, %rcx)\n"
  "  movb $1, 4(%rdx)\n"
  "  jmp con_afl_priority_only_max\n"
  "__afl_check_another:\n"
  "  movl 4(%rdx, %rcx), %eax\n"
  "  movl 32(%rdx), %ebx\n"
  "  cmpl %eax, %ebx\n"
  "  jbe __random_lock_max_than\n"
  "  incl 4(%rdx, %rcx)\n"
  "  movb $1, 4(%rdx)\n"
  "  jmp con_afl_priority_only_min\n"
  "__random_lock_max_than:"
  "  movb $1, 3(%rdx)\n"
  "  jmp __con_return\n"
  "\n"
...
/*after*/
  ...
  "  movq %rdi, -8(%rbp)\n"
  "  movl $1, %edi\n"
  CALL_L64("sched_get_priority_max")
  "  movl %eax, -12(%rbp)\n"
  "  movl  -12(%rbp), %eax\n"
  "  movl  %eax, -16(%rbp)\n"
  "  movq  -8(%rbp), %rax\n"
...
/*before*/
  ...
  "__afl_before_priority:\n"
  "\n"
  "  lahf\n"
  "  seto  %al\n"
  "\n"
  "  /* Check if CON region is already mapped. */\n"
  "\n"
  "  movq  __con_area_ptr(%rip), %rdx\n"
  "  testq %rdx, %rdx\n"
  "  je    __con_setup\n"
  ...
  "__con_store:\n"
  "\n"
  "  /* Store hit for the code location specified in rcx. */\n"
  "\n"
  ...
  "  movq  %rax, -8(%rbp)\n"
  "  movl  $1, %edi\n"
  CALL_L64("sched_get_priority_min")
  "  movl %eax, -12(%rbp)\n"
  "  movl  -12(%rbp), %eax\n"
  "  movl  %eax, -16(%rbp)\n"
  "  movq  -8(%rbp), %rax\n"
...
/* end */
  ...
  "\n"
  "  cmpb $0, __con_setup_failure(%rip)\n"
  "  jne __con_return\n"
  "\n"
  "  /* Check out if we have a global pointer on file. */\n"
  "\n"
  "  movq  __con_global_area_ptr@GOTPCREL(%rip), %rdx\n"
  "  movq  (%rdx), %rdx\n"
  "  testq %rdx, %rdx\n"
  "  je    __con_setup_first\n"
  "\n"
  "  movq %rdx, __con_area_ptr(%rip)\n"
  "  jmp  __con_store\n" 
  "\n"
  "__con_setup_first:\n"
  "\n"
  ...
  "  movq %xmm15, 336(%rsp)\n"
  "\n"
  "  /* Map SHM, jumping to __con_setup_abort if something goes wrong. */\n"
  "\n"
  ...
  "  andq  $0xfffffffffffffff0, %rsp\n"
  "\n"
  "  leaq .CON_SHM_ENV(%rip), %rdi\n"
  CALL_L64("getenv")
  "\n"
  "  testq %rax, %rax\n"
  "  je    __con_setup_abort\n"
  "\n"
  "  movq  %rax, %rdi\n"
  CALL_L64("atoi")
  "\n"
  ...
  "  movq  (%rdx), %rdx\n"
  "  testq %rdx, %rdx\n"
  "  je    __con_setup_first_only\n"
  "\n"
  "  jmp __con_return\n"
  "\n"
  "__con_setup_first_only:\n"
  "\n"
  "  /* Save everything that is not yet saved and that may be touched by\n"
  "     getenv() and several other libcalls we'll be relying on. */\n"
  "\n"
  ...
  ".CON_VARS:\n"
  "\n"
  "  .lcomm   __con_area_ptr, 8\n"
  "  .lcomm   __con_setup_failure, 1\n"
  "  .comm    __con_global_area_ptr, 8, 8\n"
  "\n"
  ".CON_SHM_ENV:\n"
  "  .asciz \"" CON_ENV_VAR "\"\n"
  "\n"
